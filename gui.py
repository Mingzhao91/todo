...
complete_button = sg.Button(size=2, image_source="complete.png", mouseover_colors="LightBlue2", tooltip="Complete",
                            key="Complete")
...
while True:
    ...
    match event:
        case "Add":
            ...
            write_todos(todos)
            # update the list after the new item is added
        ...
        case "Exit":
            break
        case "todos":
            # update the input when list item is clicked
